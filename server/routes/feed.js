...
router.get('/', optionalAuth, (req, res) => {
  ...
  // We over-fetch (up to 500) so ranking can reorder before slicing the page.
  // For large platforms this would be pre-computed; at this scale it's instant.
  const CANDIDATE_LIMIT = 500;

  const rows = db.prepare(`
    SELECT n.id, n.title, n.body, n.font, n.font_size, n.bg_url, n.tags,
           n.created_at, n.views, n.color_idx,
           u.id   AS author_id,
           u.username,
           u.display_name,
           u.avatar_url,
